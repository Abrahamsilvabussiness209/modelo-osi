...
Un sitio web interactivo tipo blog, moderno y ligero diseñado para estudiantes, entusiastas de las redes o/u profesionales junior que recientemente están ingresando al mundo de la TI, y que buscan comprender en profundidad la arquitectura del **Modelo OSI** (Open Systems Interconnection).
...
- **CSS3:** Variables CSS, Flexbox, animaciones y diseño adaptable (*Responsive Design*).
- **JavaScript (ES6):** Interacción dinámica para expandir/colapsar las tarjetas de cada capa.
...
modelo-osi/
│
├── index.html        # Estructura HTML, estilos CSS y lógica JS integrados
